...
We use the predefined movements included both in Unitree G1 and Booster T1 for walking, kicking and getting up after a fall. Our planner generate movements 
\end{document}
